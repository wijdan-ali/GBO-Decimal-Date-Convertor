...
<div style="text-align: center; display: flex; align-items: center; justify-content: center; gap: 20px;"><span style="font-size: 1.3em; font-weight: 400;">Decimal Year:    </span> <h2>{decimal_year:.6f}</h2>
</div>
